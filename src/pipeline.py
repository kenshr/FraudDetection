...
class preprocess:
    ...
    def set_classes(self):
        self.df.acct_type = self.df.acct_type.map({'premium': 0, 'fraudster_event': 2, 'fraudster': 2, 'spammer_limited': 1, 
                                                   'spammer_warn': 1, 'top_warn': 2, 'spammer_noinvite': 1, 'tos_lock':1, 'locked': 1,
                                                   'fraudster_att': 2, 'spammer_web': 1, 'spammer': 1})
